...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int c = calc.divide.apply(a, b);//если b=0, то будет производиться деление на ноль, что математически неправильно
        ...
        calc.println.accept(calc.pow.operator(-5));
        calc.println.accept(calc.abs.operator(-5));
